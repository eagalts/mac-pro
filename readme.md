...
Некоторые смогли установить Windows 11 на Mac Pro 1.1. Вот [ссылка на видео](https://youtu.be/ehDF3mrwbfE?si=OkxZQChKIMi7psVo) (YouTube, возможно, потребуется VPN, английский язык) - по ней можно попытаться установить винду. 
...
```
sudo dd if=/path/to/lubuntu.iso of=/dev/sdb 2 bs=1M status=progress
```
